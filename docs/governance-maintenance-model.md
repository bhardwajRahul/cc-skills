...
| ----------------- | ---------------------------------------------- | ------------- |
| **Workflow**      | itp, itp-hooks                                 | @terryli      |
...
1. **Automate link checking** (S1)
   - Add lychee to CI pipeline

2. **Add CLAUDE.md validation** (S2)
   - Extend validate-plugins.mjs with CLAUDE.md checks

3. **Complete documentation sections** (S3, S4)
   - Add Skills/Commands tables to plugins missing them

### Long Term

1. **Create SKILL.md schema** (L1)
2. **Build metrics dashboard** (L2)
3. **Add markdown linting** (L3)
...
_Generated by Task 9: Governance & Maintenance Model_
