---
name: launch
description: "Launch FloatingClock, preferring the installed /Applications copy and falling back to the local build. Use when the user wants to open the floating-clock app."
allowed-tools: Bash
---
