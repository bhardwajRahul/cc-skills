...
iter151_assert_substring_present_in_file \
    "D3: validator cross-references iter-150 readable-renderer task for existing-history view" \
    "$ITER151_VALIDATOR_TASK_ABSOLUTE_PATH" \
