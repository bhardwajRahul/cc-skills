...
echo ""
echo "GROUP B (2 assertions): arc range header + description header reflect iter-169 state"
...
iter170_assert_substring_present_in_dispatcher_with_human_readable_label \
    "B2: description header references 'iter-150-through-iter-169'" \
...
iter170_assert_substring_absent_in_dispatcher_with_human_readable_label \
    "C2: stale 'iter-150-through-iter-165' description header text gone" \
